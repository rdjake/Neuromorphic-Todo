...
[Попробовать <img alt="Neuromorphic Todo icon" src="public/icon.png" style="width: 2rem; transform: translateY(0.5rem);"> Neuromorphic Todo](https://rdjake.github.io/Neuromorphic-Todo/)
